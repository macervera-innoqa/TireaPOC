...
package es.tirea.wavemaker.consultaFacturas.desa.dao;
...
/**
 * Specifies methods used to obtain and modify FichProcesados related information
 * which is stored in the database.
 */
@Repository("DESA.FichProcesadosDao")
public class FichProcesadosDao extends WMGenericDaoImpl<FichProcesados, Integer> {

    @Autowired
    @Qualifier("DESATemplate")
    private HibernateTemplate template;

    @Autowired
    @Qualifier("DESAWMQLTypeHelper")
