...
/**
 * Specifies methods used to obtain and modify Facturas related information
 * which is stored in the database.
 */
@Repository("DESA.FacturasDao")
public class FacturasDao extends WMGenericDaoImpl<Facturas, Integer> {
