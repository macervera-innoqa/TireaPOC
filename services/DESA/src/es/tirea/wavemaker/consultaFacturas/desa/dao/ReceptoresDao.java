...
/**
 * Specifies methods used to obtain and modify Receptores related information
 * which is stored in the database.
 */
@Repository("DESA.ReceptoresDao")
public class ReceptoresDao extends WMGenericDaoImpl<Receptores, Integer> {
